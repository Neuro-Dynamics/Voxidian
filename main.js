  ...
  display() {
    ...
    const renderPresets = () => {
      ...
      st.promptPresets.forEach((p) => {
        ...
        new import_obsidian.Setting(wrap).setName(p.name).addButton((b) => b.setButtonText("Set as Default").onClick(async () => {
